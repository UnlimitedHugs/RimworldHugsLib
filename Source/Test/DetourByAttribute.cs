...
namespace HugsLib.Test {
	public class DetourByAttribute : ModBase {
		...
		internal new static ModLogger Logger = new ModLogger("DetoursByAttribute");
	...
	public class DetourTestSources {
		...
		public string GetterOnly {
			...
			set { Logger.Message("public getterOnly setter"); }
		}
		...
		public string SetterOnly {
			...
			set { Logger.Error("public setterOnly setter"); }
		}
		...
		public string Both {
			...
			set { Logger.Error("public both setter"); }
		}
	}
}
